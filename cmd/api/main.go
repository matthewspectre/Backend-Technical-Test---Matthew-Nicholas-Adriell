...
func main() {
	...
	inventoryUsecase := inventoryusecase.NewUsecase(inventoryRepository, warehouseRepository, productRepository)
	...
	purchaseRequestUsecase := purchaserequestusecase.NewUsecase(purchaseRequestRepository, warehouseRepository, productRepository)
